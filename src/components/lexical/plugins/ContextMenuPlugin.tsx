...
export default function ContextMenuPlugin({
  ...
  return (
    <div
      ...
      className="fixed z-50 w-52 rounded-md border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
        ...
        >
          ...
          {showSubmenu && (
            <div
              ...
              className="absolute left-full top-0 ml-0.5 w-48 rounded-md border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
            >
