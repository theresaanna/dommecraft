...
function injectStyles() {
  ...
  style.textContent = `
    ...
    @keyframes sky-fly-diagonal-up {
      from { transform: translate(-80px, calc(100vh + 80px)) rotate(45deg); }
      to { transform: translate(calc(100vw + 80px), -80px) rotate(45deg); }
    }
    @keyframes sky-fly-diagonal-down {
      from { transform: translate(calc(100vw + 80px), -80px) rotate(225deg); }
      to { transform: translate(-80px, calc(100vh + 80px)) rotate(225deg); }
    }
    @keyframes sky-rise {
