  ...
  return (
    ...
    >
          ...
          {isAdmin ? (
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-zinc-300 px-2 py-1 text-base focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
              />
              <button
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <span className="block truncate text-base text-zinc-900 dark:text-zinc-50">
                      {member.name || "Unknown"}
                      {isSelf && (
                  ...
                  {isAdmin && !isSelf && (
                    <div className="flex shrink-0 items-center gap-1">
                      <button
                        ...
                        className="rounded px-1.5 py-0.5 text-sm text-zinc-500 hover:bg-zinc-100 hover:text-zinc-700 disabled:opacity-50 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-300"
                      >
                        {member.role === "ADMIN"
                          ? "Remove Admin"
                          : "Make Admin"}
                      ...
                      <button
                        ...
                        className="rounded px-1.5 py-0.5 text-sm text-red-500 hover:bg-red-50 hover:text-red-700 disabled:opacity-50 dark:text-red-400 dark:hover:bg-red-950 dark:hover:text-red-300"
                      >
                        Remove
                      </button>
                    </div>
        ...
        {isAdmin && (
          <div className="border-b border-zinc-200 px-4 py-3 dark:border-zinc-800">
            <button
              ...
              className="w-full rounded-md border border-zinc-300 px-3 py-1.5 text-base text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
            >
                ...
                {!loadingContacts && availableContacts.length > 0 && (
                  <>
                    ...
                    <button
                      ...
                      className="mt-2 w-full rounded-md bg-sky-300/30 backdrop-blur-sm border border-sky-400/30 px-3 py-1.5 text-sm font-medium text-sky-900 transition-all hover:bg-sky-300/45 hover:shadow-[0_0_20px_rgba(56,189,248,0.5)] disabled:opacity-50 dark:border-[rgba(55,113,200,0.35)] dark:bg-[rgba(55,113,200,0.25)] dark:text-blue-100 dark:hover:bg-[rgba(55,113,200,0.4)] dark:hover:shadow-[0_0_20px_rgba(55,113,200,0.5)]"
                    >
      ...
      <div className="border-t border-zinc-200 px-4 py-3 dark:border-zinc-800">
        {leaveError && (
          <p className="mb-2 text-center text-sm text-red-500 dark:text-red-400">
            {leaveError}
          </p>
        )}
        <button
          ...
          disabled={leaving}
          className="w-full rounded-md border border-red-300 px-3 py-1.5 text-base font-medium text-red-600 hover:bg-red-50 disabled:opacity-50 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-950"
        >
